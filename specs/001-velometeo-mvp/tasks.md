...
- [ ] T002 [P] Copy `delacau-200-brm.gpx` from `../delacau-200-brm-weather-forecast/` into `routes/` and create `routes/index.json` with the Delacau entry (date 2026-05-31, start per the original event, mode brevet) per contracts/routes-config.md
